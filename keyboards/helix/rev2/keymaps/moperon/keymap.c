...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     XXXXXXX, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL, \
      _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,                    XXXXXXX, XXXXXXX, KC_GRV,  KC_QUOT, KC_SCLN, _______, \
      _______, KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_COMM, KC_DOT,  KC_SLSH, _______, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     XXXXXXX, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, _______, \
      _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,                    XXXXXXX, XXXXXXX, KC_TILD, KC_DQUO, KC_COLN, _______, \
