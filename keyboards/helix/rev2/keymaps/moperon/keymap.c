...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  XXXXXXX, KC_LALT, KC_LGUI, EISU,    LOWER, KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT \
      ),
   ...
   */
  [_LOWER] = LAYOUT( \
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, KC_EQL, \
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, KC_BSLS, KC_SLSH, KC_QUES, KC_DEL, \
   ...
   */
  [_RAISE] = LAYOUT( \
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_PLUS, \
