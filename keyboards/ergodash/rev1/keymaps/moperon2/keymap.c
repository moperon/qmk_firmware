...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    [_LOWER] = LAYOUT(
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_GRV,                        KC_RCBR, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, \
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_BSLS,                       KC_PLUS, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,  \
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LBRC,                       KC_RBRC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, KC_QUOT, \
  ...
  [_RAISE] = LAYOUT(
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_TILD,                        KC_DQUO, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_MINS, \
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_PIPE,                        KC_PLUS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_MINS, \
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LCBR,                        KC_RCBR, KC_GRV,  KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT, \
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |RGBRst|      | MODE | HUE- | SAT- | VAL- |      |                    |      | Home |PgDown| PgUp | End  |      |      |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |      |      | BLTgl|BLBrtg|  BL+ |  BL- |      |                    |      |      |      |      |      |      |      |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |      |      ||||||||      |      |      ||||||||      |      |      ||||||||      |      |      |      |
  ...
  [_ADJUST] = LAYOUT(
    ...
    RESET,   XXXXXXX, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,XXXXXXX,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    RGBRST,  XXXXXXX, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,XXXXXXX,                       XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, XXXXXXX, \
    XXXXXXX, XXXXXXX, BL_TOGG, BL_BRTG, BL_INC,  BL_DEC, QWERTY,                        KEYPAD,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
