...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] = LAYOUT(
    ...
    RESET,   XXXXXXX, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAD,XXXXXXX,                       XXXXXXX, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAD, XXXXXXX, RESET, \
    RGBRST,  XXXXXXX, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAI,XXXXXXX,                       XXXXXXX, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAI, XXXXXXX, RGBRST, \
